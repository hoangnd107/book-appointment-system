                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image_block_3">
                            <div class="image-box">
                                ...
                                <figure class="image image-1 paroller"><img src="{{asset('public/image_web').'/'.$setting->about_img_1}}" alt=""></figure>
                                <figure class="image image-2 paroller-2"><img src="{{asset('public/image_web').'/'.$setting->about_img_2}}" alt=""></figure>
