...
@section('content')
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div class="content_block_1">
                        <div class="content-box mr-50">
                            <div class="sec-title">
                                <p>{{ __('message.About Docpro') }}</p>
                                <h2>{{ __('message.Bring care to your home with one click') }}</h2>
                            </div>
                            <!--<div class="text">-->
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image_block_3">
                        <div class="image-box">
                            <div class="pattern">
                                <div class="pattern-1"
                                    style="background-image: url('{{ asset('public/front_pro/assets/images/shape/shape-49.png') }}');">
                                </div>
                                <div class="pattern-2"
                                    style="background-image: url('{{ asset('public/front_pro/assets/images/shape/shape-50.png') }}');">
                                </div>
                                <div class="pattern-3"></div>
                            </div>
                            <figure class="image image-1 paroller"><img
                                    src="{{ asset('public/image_web') . '/' . $setting->about_img_1 }}" alt="">
                            </figure>
                            <figure class="image image-2 paroller-2"><img
                                    src="{{ asset('public/image_web') . '/' . $setting->about_img_2 }}" alt="">
                            </figure>
                            <div class="image-content">
                                <figure class="icon-box"><img
                                        src="{{ asset('public/front_pro/assets/images/icons/icon-8.png') }}"
                                        alt=""></figure>
                                <span>{{ __('message.Appointment With') }}</span>
                                <h4>{{ __('message.Specialist') }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="process-style-two bg-color-3 centred">
        <div class="pattern-layer">
            <div class="pattern-1"
                style="background-image: url('{{ asset('public/front_pro/assets/images/shape/shape-39.png') }}');"></div>
            <div class="pattern-2"
                style="background-image: url('{{ asset('public/front_pro/assets/images/shape/shape-40.png') }}');"></div>
            <div class="pattern-3"
                style="background-image: url('{{ asset('public/front_pro/assets/images/shape/shape-41.png') }}');"></div>
            <div class="pattern-4"
                style="background-image: url('{{ asset('public/front_pro/assets/images/shape/shape-42.png') }}');"></div>
        </div>
        <div class="auto-container">
            ...
            <div class="inner-content">
                <div class="arrow"
                    style="background-image: url('{{ asset('public/front_pro/assets/images/icons/arrow-1.png') }}');">
                </div>
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 processing-block">
                        <div class="processing-block-two">
                            <div class="inner-box">
                                <figure class="icon-box"><img src="{{ asset('public/image_web/') . '/' . $setting->icon1 }}"
                                        alt=""></figure>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 processing-block">
                        <div class="processing-block-two">
                            <div class="inner-box">
                                <figure class="icon-box"><img src="{{ asset('public/image_web/') . '/' . $setting->icon2 }}"
                                        alt=""></figure>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 processing-block">
                        <div class="processing-block-two">
                            <div class="inner-box">
                                <figure class="icon-box"><img src="{{ asset('public/image_web/') . '/' . $setting->icon3 }}"
                                        alt=""></figure>
            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image_block_4">
                        <div class="image-box">
                            <div class="pattern"
                                style="background-image: url('{{ asset('public/front_pro/assets/images/shape/shape-54.png') }}');">
                            </div>
                            <figure class="image"><img
                                    src="{{ asset('public/front_pro/assets/images/resource/faq-1.png') }}"
                                    alt=""></figure>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div class="content_block_5">
                        <div class="content-box">
                            <div class="sec-title">
                                <p>{{ __('message.Faq’s') }}</p>
                                <h2>{{ __('message.Frequently Asked Questions.') }}</h2>
                            </div>
                            <ul class="accordion-box">
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"></div>
                                        <h4>{{ __('message.How do I contact customer service?') }}</h4>
                                    </div>
                                ...
                                <li class="accordion block active-block">
                                    <div class="acc-btn active">
                                        <div class="icon-outer"></div>
                                        <h4>{{ __('message.Do doctors pay for good reviews?') }}</h4>
                                    </div>
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"></div>
                                        <h4>{{ __('message.Why didn t my review get posted?') }}</h4>
                                    </div>
                                    <div class="acc-content">
                                        <div class="text">
                                            <p>{{ __('message.Ans3') }}</p>
