                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">{{ __('message.User Report') }}</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item active">{{ __('message.User Report') }}</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <h4 class="card-title">
                            @if (Request::get('data_filter'))
                                @if ($total == null)
                                    {{ __('message.User not found') }}
                                @else
                                    {{ __('message.Total user register are') }} {{ $total }}
                                @endif
                            @else
                                {{-- {{ __('message.User List') }} --}}
                            @endif
                        </h4>
